...
class Test_Abdul:
    ...
    def test_login(self, booting_function):
        ...
        assert self.test_login == self.test_login
        print("SUCCESS : Logged in with Username {a} and Password {b}". format(a=data.Abdul_Data.username, b=data.Abdul_Data.password))
